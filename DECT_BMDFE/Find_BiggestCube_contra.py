...
gsi_name = participant_id+'_GSI_Baseline_contra'
...
mask_name = participant_id+'_'+bone_id+'_Edema_Mask_Contra'
...
dilate_filter.SetKernelRadius(0)
...
# cl_relabeled_largest.SetPixel(188,213,186,0) #For SALTACII_0028 -- if more than one voxel at max thickness location, set extra voxel to zero
# cl_relabeled_largest.SetPixel(135,220,184,0) #For SALTACII_0032 -- if more than one voxel at max thickness location, set extra voxel to zero

cl_relabeled_largest.SetPixel(146,195,195,0) #For SALTACII_0013 -- need to adjust cube location to fit entirely within HR-pQCT
cl_relabeled_largest.SetPixel(146,195,193,1) #For SALTACII_0013 -- need to adjust cube location to fit entirely within HR-pQCT


#create cube VOI
# r = int(round(max_value*np.sqrt(2)/2))
# print(r)
# r = 6 #same size cube as injured side, SALTACII_0008, SALTACII_0015, SALTACII_0005, SALTACII_0011, SALTACII_0023
# r = 5 #same size cube as injured side, SALTACII_0018, SALTACII_0010, SALTACII_0026, SALTACII_0028, SALTACII_0034
r = 4 #same size cube as injured side, SALTACII_0007, SALTACII_0009, SALTACII_0002, SALTACII_0004, SALTACII_0012, SALTACII_0013, SALTACII_0016, SALTACII_0022, SALTACII_0032
...
sitk.WriteImage(square_voi,filePath+'/'+participant_id+'_largestcube_contra.mha',True)
